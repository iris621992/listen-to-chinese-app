...
export const HOME_COPY: Record<HomeLocaleCode, HomeCopy> = {
  "en": {
    ...
    "hero": {
      ...
      "exploreBody": "Start with a resource, a language question, or available practice.",
    ...
    "library": {
      ...
      "practiceOnlyBody": "Use resources built primarily for focused exercises.",
    ...
    "practice": {
      ...
      "body": "Use exercises connected to published resources now, while the independent practice library continues to grow.",
      "tags": [
        "Mixed",
        "Vocabulary",
        "Grammar",
      ...
      "featureBody": "Use exercises attached to a published resource when they are available.",
      "cta": "Start Practice"
    },
    "discovery": {
      "eyebrow": "DISCOVERY",
    ...
    "guest": {
      ...
      "guestBody": "Explore published resources and the current Knowledge and Practice hubs without an account.",
    ...
    "positioning": {
      ...
      "startBody": "Open the Library, look something up in Knowledge, or begin with Practice.",
      "moveTitle": "Move between systems",
      "moveBody": "Go from a resource to Knowledge and Practice while keeping learner context.",
  ...
  "vi": {
    ...
    "hero": {
      ...
      "body": "Khám phá nghe, đọc, từ vựng, ngữ pháp, thành ngữ và bài tập có cấu trúc — tất cả ở một nơi.",
      ...
      "exploreBody": "Bắt đầu từ một tài nguyên, một câu hỏi ngôn ngữ hoặc bài tập hiện có.",
      ...
      "miniPracticeBody": "Tổng hợp · Từ vựng · Ngữ pháp · Chính tả nghe · Dịch"
    },
    "library": {
      "eyebrow": "THƯ VIỆN",
      "title": "Tìm tài nguyên phù hợp với nhu cầu học của bạn.",
      "body": "Duyệt tài nguyên tiếng Trung theo loại, cấp độ và ngôn ngữ.",
      "videoTitle": "Video",
      "videoBody": "Học với tài nguyên video tiếng Trung.",
      "listeningTitle": "Nghe",
      "listeningBody": "Luyện khả năng hiểu tiếng Trung qua nghe.",
      "readingTitle": "Đọc",
      "readingBody": "Đọc tiếng Trung trong những ngữ cảnh có ý nghĩa.",
      "practiceOnlyTitle": "Chỉ luyện tập",
      "practiceOnlyBody": "Dùng các tài nguyên được xây dựng chủ yếu cho bài tập tập trung.",
    ...
    "knowledge": {
      ...
      "vocabTitle": "Từ vựng",
      "vocabBody": "Tìm hiểu nghĩa, cách dùng và ngôn ngữ liên quan.",
      "idiomTitle": "Thành ngữ",
      "idiomBody": "Hiểu các cách diễn đạt và cách chúng được sử dụng.",
      "compareTitle": "So sánh từ",
      "compareBody": "Xem các từ gần nhau khác nhau thế nào về nghĩa và cách dùng.",
      "grammarTitle": "Ngữ pháp",
      "grammarBody": "Ôn các mẫu ngữ pháp với ví dụ rõ ràng.",
      "cta": "Xem Kiến thức"
    },
    "practice": {
      "eyebrow": "LUYỆN TẬP",
      "title": "Luyện tập những gì bạn khám phá.",
      "body": "Dùng bài tập gắn với tài nguyên đã xuất bản hiện nay, trong khi thư viện luyện tập độc lập tiếp tục phát triển.",
      "tags": [
        "Tổng hợp",
        "Từ vựng",
        "Ngữ pháp",
      ...
      "featureBody": "Dùng các bài tập gắn với một tài nguyên đã xuất bản khi có sẵn.",
      "cta": "Bắt đầu Luyện tập"
    },
    "discovery": {
      "eyebrow": "KHÁM PHÁ",
      "title": "Tìm nội dung phù hợp với bạn.",
    ...
    "guest": {
      ...
      "guestBody": "Xem tài nguyên đã xuất bản và các khu Kiến thức, Luyện tập hiện tại mà không cần tài khoản.",
    ...
    "how": {
      ...
      "body": "Không có trình tự cố định. Hãy bắt đầu từ nơi hữu ích với bạn.",
      "discover": "Khám phá",
    ...
    "positioning": {
      ...
      "title": "Tài nguyên, kiến thức và luyện tập ở cùng một nơi.",
      "body": "Di chuyển giữa tài nguyên học tập, phần tra cứu ngôn ngữ và luyện tập tập trung mà không phải theo một lộ trình khóa học cố định.",
      "startTitle": "Bắt đầu ở bất cứ đâu",
      "startBody": "Mở Thư viện, tra cứu trong Kiến thức hoặc bắt đầu với Luyện tập.",
      "moveTitle": "Di chuyển giữa các hệ thống",
      "moveBody": "Đi từ một tài nguyên sang Kiến thức và Luyện tập mà vẫn giữ ngữ cảnh người học.",
    ...
    "growing": {
      ...
      "title": "Một thư viện được thiết kế để phát triển cùng tài nguyên.",
      "body": "YunChinese tập hợp các tài nguyên tiếng Trung và công cụ học hữu ích trong một thư viện có thể tiếp tục mở rộng theo thời gian.",
      "note": "Ý tưởng thực vật gắn với chữ 芸 có thể truyền cảm hứng cho ngôn ngữ hình ảnh về sự sinh trưởng, trong khi sản phẩm vẫn tập trung vào tài nguyên, kiến thức và luyện tập hữu ích."
    },
    "final": {
    ...
    "footer": {
      "tagline": "Tài nguyên tiếng Trung, kiến thức và luyện tập — cùng trong một thư viện."
    }
  },
  "ar": {
    "nav": {
    ...
    "hero": {
      ...
      "body": "استكشف الاستماع والقراءة والمفردات والقواعد والتعابير الاصطلاحية والتدريب المنظم — كلها في مكان واحد.",
      ...
      "exploreBody": "ابدأ بمورد أو سؤال لغوي أو تدريب متاح.",
      "miniLibraryTitle": "المكتبة",
      "miniLibraryBody": "فيديو · استماع · قراءة · مجموعات مراجعة",
      "miniKnowledgeTitle": "المعرفة",
      "miniKnowledgeBody": "مفردات · تعابير اصطلاحية · مقارنة الكلمات · قواعد",
      "miniPracticeTitle": "التدريب",
      "miniPracticeBody": "مختلط · مفردات · قواعد · إملاء · ترجمة"
    },
    "library": {
      "eyebrow": "المكتبة",
      ...
      "videoTitle": "فيديو",
      "videoBody": "تعلّم باستخدام موارد فيديو باللغة الصينية.",
      "listeningTitle": "استماع",
      "listeningBody": "درّب فهمك للصينية المنطوقة.",
      "readingTitle": "قراءة",
      "readingBody": "اقرأ الصينية في سياقات ذات معنى.",
      "practiceOnlyTitle": "للتدريب فقط",
      "practiceOnlyBody": "استخدم موارد صُممت أساسًا للتمارين المركزة.",
      "reviewTitle": "مجموعات مراجعة",
      "reviewBody": "عُد إلى موارد ونقاط لغوية مختارة.",
      "cta": "استكشف المكتبة",
    ...
    "knowledge": {
      "eyebrow": "المعرفة",
      "title": "افهم الصينية التي تقرؤها وتسمعها.",
      "body": "استكشف المفردات والتعابير الاصطلاحية والقواعد والفروق بين الكلمات المتشابهة.",
      "vocabTitle": "المفردات",
      "vocabBody": "استكشف المعنى والاستخدام واللغة المرتبطة به.",
      "idiomTitle": "التعابير الاصطلاحية",
      "idiomBody": "افهم التعابير وكيف تُستخدم.",
      "compareTitle": "مقارنة الكلمات",
      "compareBody": "تعرّف إلى اختلاف الكلمات المتشابهة في المعنى والاستخدام.",
    ...
    "practice": {
      ...
      "body": "استخدم التمارين المرتبطة بالموارد المنشورة الآن، بينما تواصل مكتبة التدريب المستقل نموها.",
      "tags": [
        "مختلط",
        "مفردات",
        "قواعد",
      ...
      "featureTitle": "تدرّب من مورد",
      "featureBody": "استخدم التمارين المرتبطة بمورد منشور عندما تكون متاحة.",
      "cta": "ابدأ التدريب"
    },
    "discovery": {
      "eyebrow": "الاكتشاف",
    ...
    "guest": {
      ...
      "guestBody": "استكشف الموارد المنشورة وأقسام المعرفة والتدريب الحالية دون حساب.",
    ...
    "how": {
      ...
      "body": "لا يوجد تسلسل ثابت. ابدأ من المكان المفيد لك.",
      "discover": "استكشف",
    ...
    "positioning": {
      ...
      "body": "تنقّل بين موارد التعلّم والمراجع اللغوية والتدريب المركّز دون اتباع مسار دراسي ثابت.",
      "startTitle": "ابدأ من أي مكان",
      "startBody": "افتح المكتبة أو ابحث عن شيء في المعرفة أو ابدأ بالتدريب.",
      "moveTitle": "تنقّل بين الأنظمة",
      "moveBody": "انتقل من مورد إلى المعرفة والتدريب مع الحفاظ على سياق المتعلم.",
      "courseTitle": "لا يوجد مسار دراسي ثابت",
      "courseBody": "استخدم الأجزاء من YunChinese التي تفيدك."
    },
    "growing": {
      "eyebrow": "مكتبة متنامية",
      "title": "مكتبة صُممت لتنمو مع مواردها.",
      "body": "يجمع YunChinese موارد صينية وأدوات تعلم مفيدة في مكتبة يمكنها الاستمرار في التوسع مع الوقت.",
      "note": "يمكن لفكرة النبات المرتبطة بالحرف 芸 أن تلهم لغة بصرية للنمو، بينما يظل المنتج متمحورًا حول الموارد والمعرفة والتدريب المفيدة."
    },
    "final": {
      "title": "استكشف YunChinese.",
      "body": "اعثر على مورد، وابحث عن شيء تريد فهمه، أو ابدأ التدريب.",
      "ctaLibrary": "استكشف المكتبة",
      "ctaKnowledge": "تصفح المعرفة",
      "ctaPractice": "ابدأ التدريب"
    },
    "footer": {
      "tagline": "موارد صينية ومعرفة وتدريب — معًا في مكتبة واحدة."
    }
  }
};
